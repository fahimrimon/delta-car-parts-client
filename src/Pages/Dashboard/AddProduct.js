...
const AddProduct = () => {
  ...
  return (
    <div className="justify-center ">
      <h2 className="mb-5 mt-3 text-secondary">Please add  a new Product</h2>
      <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
        ...
        <input class="input input-bordered w-full max-w-xs my-3" placeholder="Minimum Order Quantity" type="number" {...register("minquantity")} />
        <input class="input input-bordered w-full max-w-xs" placeholder="Available Quantity" type="number" {...register("totalquantity")} />
