...
const MyReview = () => {
  ...
  return (
    <div className="justify-center ">
      <h2 className='mb-5 mt-3 text-secondary'>Please add your positive review!</h2>
      <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
        <input class=" input input-bordered w-full max-w-xs" placeholder="Name" {...register("name", { required: true, maxLength: 20 })} />
        ...
        <input class="input input-bordered w-full max-w-xs my-3" placeholder="Enter Your Location" type="text" {...register("location")} />
